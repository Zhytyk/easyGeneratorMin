    ...
    return {
        ...
        activate: function () {
            router.map([
               ...
               { route: 'preview/course/:courseId', title: 'Preview mode', moduleId: 'preview/viewmodels/previewmainpage', nav: true},
               { route: 'preview/course/:courseId/section/:sectionId', title: 'Preview section', moduleId: 'preview/viewmodels/previewsectionpage', nav: true },
